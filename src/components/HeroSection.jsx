...
>
      ...
      <div className="absolute inset-0 top-0 lg:pl-20 flex items-center justify-start  sm:pl-10  md:pl-20">
        <div className="ml-8 max-w-lg text-black">
          <h1 className="text-6xl lg:text-8xl font-bold mb-4 text-blue-800">
            Zero fees
          </h1>
          ...
          <a
            href="#"
            className="bg-blue-800 hover:bg-blue-700 text-white lg:text-2xl font-semibold py-4 px-10 rounded-md inline-flex items-center space-x-2"
          >
